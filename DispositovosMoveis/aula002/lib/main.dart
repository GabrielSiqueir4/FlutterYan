...
import 'package:ollamundo/models/chamados.dart';
...
class _AppChamadosState extends State<AppChamados> {
  ...
  void _refresMateriais(String materiais, bool status) {
    materiaisSelecionados[materiais] = status;
